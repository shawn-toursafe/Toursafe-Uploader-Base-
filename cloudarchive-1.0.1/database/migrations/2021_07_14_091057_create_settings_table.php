    ...
    public function up()
    {
        ...
        DB::table('settings')->insert(
            [      
                ...
                [
                    'name' => 'title',
                    'value' => 'CloudArchive - Cloud Data Archival'
                ],
                [
                    'name' => 'author',
                    'value' => 'Berkine'
                ...
                [
                    'name' => 'keywords',
                    'value' => 'cloud, cloudarchive'
                ],
                [
                    'name' => 'description',
                    'value' => 'Cloud Archive - Cloud Data Archival'
                ],
                [
                    'name' => 'referral_headline',
                    'value' => 'Invite your friends to CloudArchive, if they sign up, you will get 100MB and you will also get 50% commission of thier first purchase.'
                ],
                [
                    ...
                    'value' => '1. Share your referral link with your friends to register
                                ...
                                3. For their first purchase on CloudArchive, you will receive 50% of commissions
