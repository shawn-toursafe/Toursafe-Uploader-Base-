...
<aside class="app-sidebar"> 
    ...
    <ul class="side-menu app-sidebar3">
        @role('admin')
            ...
            <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                        ...
                        <span class="side-menu__label">{{ __('Archive Management') }}</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.archive.dashboard') }}" class="slide-item">{{ __('Archive Dashboard') }}</a></li>
                        <li><a href="{{ route('admin.archive.list') }}" class="slide-item">{{ __('Archives') }}</a></li>
                        <li><a href="{{ route('admin.archive.configs') }}" class="slide-item">{{ __('Archive Settings') }}</a></li>
                    </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.finance.plans') }}" class="slide-item">{{ __('Plans') }}</a></li>
                        <li><a href="{{ route('admin.finance.subscriptions') }}" class="slide-item">{{ __('Subscriptions') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('user.archive.upload')}}">
            <span class="side-menu__icon fa-solid fa-cloud-arrow-up"></span>
            <span class="side-menu__label">{{ __('Upload Archive') }}</span></a>
        </li>
        <li class="slide">
            <a class="side-menu__item" href="{{ route('user.archive.list')}}">
            <span class="side-menu__icon fa-solid fa-box-archive"></span>
            <span class="side-menu__label">{{ __('My Archives') }}</span></a>
        </li>            
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a href="{{ route('user.plans') }}" class="slide-item">{{ __('Subscribe Now') }}</a></li>                
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                <span class="side-menu__icon fa-solid fa-user-shield"></span>
                <span class="side-menu__label">{{ __('My Profile') }}</span><i class="angle fa fa-angle-right"></i>
            </a>
            <ul class="slide-menu">
                <li><a href="{{ route('user.profile')}}" class="slide-item">{{ __('My Profile Settings') }}</a></li>
                <li><a href="{{ route('user.security') }}" class="slide-item">{{ __('Security Settings') }}</a></li>
            </ul>
        </li>
        @role('user|subscriber')
