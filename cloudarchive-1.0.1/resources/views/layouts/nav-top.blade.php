                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
                        ...
                        @if (config('settings.user_notification') == 'enabled')
                            @role('user|subscriber')
                                @if (auth()->user()->unreadNotifications->where('type', 'App\Notifications\GeneralNotification')->count())
                                    <div class="dropdown-header">
                                        <h6 class="mb-0 fs-12 font-weight-bold">{{ auth()->user()->unreadNotifications->where('type', 'App\Notifications\GeneralNotification')->count() }} <span class="text-primary">{{ __('New') }}</span> {{ __('Notification(s)') }}</h6>
                                        <a href="#" class="mb-1 badge badge-primary ml-auto pl-3 pr-3 mark-read" id="mark-all">{{ __('Mark All Read') }}</a>
                                    </div>
                                    <div class="notify-menu">
                                        <div class="notify-menu-inner">
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        ...
                        <a class="dropdown-item d-flex" href="{{ route('user.plans') }}">
                            ...
                            <div class="fs-12">{{ __('Subscribe Now') }}</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.archive.upload') }}">
                            <span class="profile-icon fa-solid fa-cloud-arrow-up"></span>
                            <div class="fs-12">{{ __('Upload Archive') }}</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.archive.list') }}">
                            <span class="profile-icon fa-solid fa-box-archive"></span>
                            <div class="fs-12">{{ __('My Archives') }}</div>
                        </a>
